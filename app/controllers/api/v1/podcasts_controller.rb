class Api::V1::PodcastsController < ApplicationController
  ...
  private
    ...
    def get_podcast_detail(collectionId)
      url = "https://itunes.apple.com/lookup?id=#{collectionId}&media=podcast&entity=podcastEpisode&limit=400&attribute=descriptionTerm"
      response = RestClient.get(url)
    end
