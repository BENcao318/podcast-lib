...
function PlayButton({ handlePlay, episode }) {
  return (
    <div className='border-2 rounded-xl px-2 py-1 flex gap-2 items-center hover:border-sky-600 cursor-pointer' onClick={() => handlePlay(episode)}>
